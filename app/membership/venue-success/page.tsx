...
function SuccessContent() {
  ...
  useEffect(() => {
    ...
    fetch("/api/fulfill-venue-membership", {
      method: "POST",
    ...
    <div className="min-h-screen bg-[#1A1210] flex flex-col items-center justify-center px-6 text-center">
      ...
      {state === "loading" && (
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-[rgba(250,248,245,0.4)] text-sm">Activating your venue plan…</p>
        </div>
      )}
        ...
        <div className="flex flex-col items-center gap-6 max-w-sm">
          ...
          <div>
            <h1 className="font-serif text-3xl text-[#FAF8F5] mb-3">
              {TIER_LABELS[membership ?? ""] ?? "Plan"} activated
            </h1>
            <p className="text-[rgba(250,248,245,0.4)] text-base leading-relaxed">
              Your venue plan is now active. Open the Friendly app and go to your venue dashboard to see the updated tier.
            </p>
          </div>
          <a
            href="/"
      ...
      {state === "error" && (
        <div className="flex flex-col items-center gap-6 max-w-sm">
          ...
          <div>
            ...
            <p className="text-[rgba(250,248,245,0.4)] text-base leading-relaxed">
              Your payment may have gone through but the plan wasn&apos;t activated. Email us at{" "}
